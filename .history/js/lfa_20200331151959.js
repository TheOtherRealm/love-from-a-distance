...
Vue.component('be', {
	props: ['tobe'],
	template: '<p>Would you like to be <span class="bold">yourself</span>, a <span class='bold'>predesigned</span> fictional	character<span class='gray superscript' title="(Potentially costs money)">$</span>, a fictional character
	<span class='bold'>you create</span>, or <span class='bold'>multiple</span> characters<span
