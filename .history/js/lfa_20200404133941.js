...
(function () {
	...
	Handlebars.registerHelper('input-text',function(c,o){
		var html='<p><label for="name">Enter your name<span class="gray">*</span>:</label><br><input type="text" id="name" name="name" placeholder="Your Name" required class="form-control"></p>'
	});
	var source = $('#app').html();
