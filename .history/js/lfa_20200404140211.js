...
(function () {
	...
	Handlebars.registerHelper('input-text', function(c,o){
		console.log(c,';',o);
		var html='<p><label for="'+c.id+'">Enter your name<span class="gray">*</span>:</label><br>\
		<input type="text" id="'+namc.id+'" name="name" placeholder="Your Name" required class="form-control"></p>'
		return html;
	});
	var source = $('#app').html();
