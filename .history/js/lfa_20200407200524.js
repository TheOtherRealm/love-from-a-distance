		...
		$('form').submit(function (f) {
			...
			$('#' + form.attr('id') + ' input, #' + form.attr('id') + ' select, #' + form.attr('id') + ' textarea').each(function (inte, el) {
				$(el).each(function (i, e) {
					console.log((!$(this).data("type") )?e.id:$(this).data("type"),{ id: e.id, value: e.value, type: $(this).data("type") }, serialized[i]);
					dataarr.push.from(!$(this).data("type") )?e.id:$(this).data("type"))={ id: e.id, value: e.value, type: $(this).data("type") };
				});
			});
			// .then(function(){
