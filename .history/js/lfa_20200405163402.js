	...
	const data = {
		...
		you: {
			...
			phone: {
				id: 'phone',
				type: 'input-tel',
				label: 'Enter your phone number (ex: 1-234-567-890)',
			...
			waysto: {
				...
				label: '<p>Would you like to be <span class="bold">yourself</span>, a <span class="bold">predesigned</span> fictional character<span class="gray superscript" title="(Potentially costs money)">$</span>, or a fictional character<span class="bold"> you create</span>',
				option: [
