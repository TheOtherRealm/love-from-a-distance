...
(function () {
	...
	*/
	Handlebars.registerHelper('textarea', function (c, o) {
		...
		<textarea id="'+ c.id + '" maxlength="100000" minlength="150" name="' + c.id + '" class="form-control" title="' + c.text + '" placeholder="' + c.text + '" ' + (c.required ? "require" : '') + ' aria-required="true" ></textarea>';
		return html;
	});
