	...
	*/
	...
	$(document).ready(function () {
		...
		$('form').submit(function (f) {
			f.preventDefault();
			let form = $(this);
			console.log($(this).attr('id')); let serialized = {};
			jQuery.each($('#' + form.attr('id') + ' input, #' + form.attr('id') + ' select, #' + form.attr('id') + ' textarea'),function (inte, el) {
				...
				db.put({ "_id": $(this).attr('id'), "data": serialized });
			}).then(function () {
