...
(function () {
	...
	Handlebars.registerHelper('textarea', function (c, o) {
		...
		<textarea id="'+ c.id + '" maxlength="100000" minlength="150" name="' + c.id + '" class="form-control" title="' + c.text + '" placeholder="' + c.text + '" ' + (c.required ? "required" : '') + ' data-type="select-multiple" aria-required="' + (c.required ? true : false) + '" ></textarea>';
		return html;
	});
